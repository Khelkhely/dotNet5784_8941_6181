...
public static class Initialization
{
    ...
    private static void createTasks()
    {
        ...
        for (int i = 0; i < 20; i++) 
        {
            ...
            TimeSpan effortTime = TimeSpan.FromDays(s_rand.Next(1, 15)); //choose a number of days between 1 to 15
            Task newTask = new Task(0, alias, TaskDescriptions[i], created, null, null, effortTime, null, TaskDeliverables[i], TaskRemarks[i], 0, complexity);
